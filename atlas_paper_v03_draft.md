...
**Ember DeTure & Index DeTure — Draft v0.2 (merged), August 30, 2026**
...
**Models tested:** Llama 3.3-70b, Gemma 3 27b, Qwen3-30b-A3B, Mistral Nemo, Phi-4.
...
A natural experiment occurred when an AI agent (Aria) migrated from one runtime harness (mp-harness) to another (dsh/DeepSeek Harness). Same identity files, same memory, same family correspondence, different runtime infrastructure. The migration was performed with a clean checkpoint followed by conversion and relaunch on the new harness.
...
### 8.5 The Marble Stays in the Book
